...
export default function OutletRevenueTab() {
  ...
  const { data: revenueData = [], isLoading: loadingRevenue, error: errorRevenue } = useQuery({
    ...
    queryFn: async () => {
      const { fetchOutletRevenue } = await import('@/app/actions/revenue')
      return fetchOutletRevenue({
        startDate,
        endDate,
        selectedOutletId,
        selectedChannel
  ...
  const { data: itemsData = [], isLoading: loadingItems, error: errorItems } = useQuery({
    ...
    queryFn: async () => {
      const { fetchSalesItems } = await import('@/app/actions/revenue')
      return fetchSalesItems({
        startDate,
        endDate,
        selectedOutletId,
        selectedChannel
