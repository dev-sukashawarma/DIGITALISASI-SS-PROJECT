-- Migration to filter out items with 0 total quantity from sales_items_spv
-- V3: Adds HAVING clause to prevent cancelled/voided items from appearing with 0 qty and 0 revenue
