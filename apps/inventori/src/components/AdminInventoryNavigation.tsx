...
export function AdminInventoryNavigation({ active }: { active: Section }) {
  ...
  return <>
    <aside className="hidden w-[260px] shrink-0 self-stretch rounded-[2rem] bg-[#4A1713] text-white shadow-xl shadow-orange-950/10 lg:flex lg:flex-col">
      <div className="flex flex-col items-center justify-center p-6 pb-3 text-center"><div className="mb-2 flex h-14 w-14 items-center justify-center overflow-hidden rounded-full border border-white/10 bg-white/5 shadow-inner"><img src="/logo.png" alt="Suka Shawarma" className="h-full w-full object-cover" /></div><div className="text-lg font-extrabold tracking-tight">Suka<span className="text-[#f29744]">Admin</span></div><div className="mt-1 text-[9px] font-black uppercase tracking-[0.2em] text-[#f29744]/80">Inventori Hub</div></div>
