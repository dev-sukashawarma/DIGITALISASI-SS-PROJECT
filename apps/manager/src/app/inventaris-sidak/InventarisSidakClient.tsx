...
import { AlertTriangle, Camera, Check, CheckCircle2, ChevronRight, ClipboardCheck, FileCheck2, Loader2, MapPin, Search, ShieldCheck, Store, X } from 'lucide-react'
...
function ChecklistRow({ item, status, onCheck }: { item: SidakSubmission['items'][number]; status?: CheckStatus; onCheck: (id: string, status: CheckStatus) => void }) {
