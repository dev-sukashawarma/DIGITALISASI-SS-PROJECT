...
DROP TRIGGER IF EXISTS on_surat_jalan_dikirim_send_push ON public.surat_jalan;

CREATE TRIGGER on_surat_jalan_dikirim_send_push
AFTER UPDATE ON public.surat_jalan
FOR EACH ROW
EXECUTE FUNCTION public.trigger_distribusi_push_notification();
...
DROP TRIGGER IF EXISTS on_stok_balance_update_send_push ON public.stok_balance;

CREATE TRIGGER on_stok_balance_update_send_push
AFTER UPDATE ON public.stok_balance
FOR EACH ROW
EXECUTE FUNCTION public.trigger_stok_minimum_push_notification();
