...
export default function StaffPage() {
  ...
  const handleExportCsv = () => {
    ...
    const flat = filteredStaff.map((s) => ({
      ...
      tunjangan_makan: s.financials?.allowance_meal ?? s.financials?.allowance_presence ?? 0,
      tunjangan_transportasi: s.financials?.allowance_transport || 0,
      tunjangan_telekomunikasi: s.financials?.allowance_communication || 0,
      sales_bonus: s.financials?.sales_bonus || 0,
      tunjangan_jabatan: s.financials?.allowance_position || 0,
      potongan_kasbon: s.financials?.deduction_kasbon || 0,
      potongan_bpjs: s.financials?.deduction_bpjs || 0,
    ...
    exportCsv(
      ...
      [
        ...
        { key: 'tunjangan_transportasi', label: 'Tunjangan Transport' },
        { key: 'tunjangan_telekomunikasi', label: 'Tunjangan Komunikasi' },
        { key: 'sales_bonus', label: 'Sales Bonus' },
        { key: 'tunjangan_jabatan', label: 'Tunjangan Jabatan' },
        { key: 'potongan_kasbon', label: 'Potongan Kasbon' },
        { key: 'potongan_bpjs', label: 'Potongan BPJS' },
        { key: 'bank', label: 'Bank' },
              ...
              initial={
                editingStaff
                  ? {
                      ...
                      allowance_meal: editingStaff.financials?.allowance_meal ?? editingStaff.financials?.allowance_presence ?? 0,
                      allowance_transport: editingStaff.financials?.allowance_transport || 0,
                      allowance_communication: editingStaff.financials?.allowance_communication || 0,
                      sales_bonus: editingStaff.financials?.sales_bonus || 0,
                      deduction_kasbon: editingStaff.financials?.deduction_kasbon || 0,
                      deduction_bpjs: editingStaff.financials?.deduction_bpjs || 0,
