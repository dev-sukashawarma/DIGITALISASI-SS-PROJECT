    ...
    return (
      <AppLayout>
        <div className="min-h-screen bg-[#fff8f1] text-[#1e1b15] pb-16">
          ...
          <main className="max-w-md mx-auto px-4 mt-16 text-center space-y-4">
            <div className="p-6 bg-white rounded-2xl border border-suka-brown/10 shadow-sm">
              <p className="text-suka-brown font-bold text-sm">
                Silakan pilih outlet terlebih dahulu melalui menu di atas untuk memulai opname.
              </p>
            </div>
          </main>
        </div>
    ...
    <AppLayout>
      <div className="min-h-screen bg-[#fff8f1] text-[#1e1b15] pb-16">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 mt-6">
          <OpnameForm outletId={effectiveOutletId} createdBy={outletStaff.id} role={outletStaff.role} />
        </main>
      </div>
    </AppLayout>
  );
