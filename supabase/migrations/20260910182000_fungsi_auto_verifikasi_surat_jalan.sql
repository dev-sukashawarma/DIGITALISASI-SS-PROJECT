-- 20260910182000_fungsi_auto_verifikasi_surat_jalan.sql
-- Menutup surat jalan yang sudah lewat harinya, dianggap diterima sesuai kirim.
--
-- ⚠️ BELUM DIJADWALKAN. Fungsi ini tidak akan pernah jalan sampai ada migration
--    terpisah yang mendaftarkannya ke pg_cron (rencana: 14 September).
--
