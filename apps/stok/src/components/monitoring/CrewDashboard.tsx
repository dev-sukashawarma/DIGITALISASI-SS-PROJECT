...
export function CrewDashboard() {
  ...
  return (
    <div className="pb-32 space-y-6">
      {/* Top Header App Bar */}
      <header className="bg-[#fff8f1] sticky top-0 z-40 w-full px-4 py-4 flex flex-col gap-2 border-b border-[#701604]/10 shadow-sm">
        ...
        <div className="flex items-center gap-2 text-xs">
          <span className="bg-[#a43c26] text-white px-3 py-1 rounded-full font-semibold">
      ...
      <section className="px-4 flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 no-scrollbar">
        <Link href="/stok/ledger/new" className="flex-shrink-0 bg-white border border-gray-200 rounded-xl p-4 flex flex-col items-center gap-2 min-w-[100px] shadow-sm hover:shadow transition-all active:scale-95">
          <div className="w-12 h-12 rounded-full bg-[#f29744]/10 flex items-center justify-center">
            <span className="text-xl">📒</span>
          </div>
          <span className="text-xs font-semibold text-gray-600">Entri Ledger</span>
        </Link>
        <Link href="/stok/opname/new" className="flex-shrink-0 bg-white border border-gray-200 rounded-xl p-4 flex flex-col items-center gap-2 min-w-[100px] shadow-sm hover:shadow transition-all active:scale-95">
          <div className="w-12 h-12 rounded-full bg-[#f29744]/10 flex items-center justify-center">
            <span className="text-xl">📋</span>
          </div>
