...
async function checkJatiwaringinOrders() {
  ...
  if (!outlet) {
    console.log("Outlet Jatiwaringin not found. Available outlets:")
  ...
  console.log(`\n=== PESANAN TIKTOK GO DI JATIWARINGIN TANGGAL 13 AGUSTUS 2026 ===`)
  if (!orders || orders.length === 0) {
    ...
    console.log(`\nGRAND TOTAL JATIWARINGIN: Rp ${grandTotal.toLocaleString('id-ID')}`)
    console.log(`REKAP PER ITEM:`, JSON.stringify(summary, null, 2))
  }
}

checkJatiwaringinOrders()
