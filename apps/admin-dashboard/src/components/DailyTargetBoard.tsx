                        ...
                        <span className="text-xs font-extrabold text-suka-ink truncate">
                          ...
                          {isMoreThanOneDay && r.date_value && (
                            <span className="ml-1 text-[10px] font-medium text-suka-gray-500 whitespace-nowrap">
                              ({new Date(r.date_value).toLocaleDateString('id-ID', { timeZone: 'Asia/Jakarta',  day: 'numeric', month: 'short' })})
                            </span>
                          )}
                        </span>
                      </div>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={currentTarget ? currentTarget.toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' }) : 'mis. 5.000.000'}
