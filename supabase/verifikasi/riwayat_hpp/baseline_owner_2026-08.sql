-- Bagian per-periode (Agustus) dari query kanonik di baseline_owner.sql,
...
SELECT '2026-08' AS periode, t.outlet,
       public.get_owner_dashboard_summary(timestamptz '2026-08-01 00:00:00+07', timestamptz '2026-08-31 23:59:59.999+07', t.outlet_id) ->> 'total_cogs' AS total_cogs
FROM target t
ORDER BY 1, 2;
