    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm h-16 px-4 sm:px-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <a href={process.env.NEXT_PUBLIC_PORTAL_URL || 'https://app.sukashawarma.com'} className="p-2 -ml-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-100 transition-colors">
