...
async function checkSukmajayaOrders() {
  ...
  if (sukmajayaOutlet) {
    console.log(`Outlet found: ${sukmajayaOutlet.name} (${sukmajayaOutlet.id})`)
    ...
    if (error) console.error("Error:", error)
      ...
      console.log(`\n=== PESANAN TIKTOK GO DI SUKMAJAYA TANGGAL 13 AGUSTUS 2026 ===`)
      if (orders?.length === 0) {
    ...
    console.log("Outlet Sukmajaya not found.")
  }
}

checkSukmajayaOrders()
