-- 20260908150000_guard_harga_master_po_uji_coba.sql
--
-- Menolak PO uji coba menulis harga ke master produksi.
-- Melanjutkan 20260904120000 (guard salah satuan), memakai ulang jalur
-- penolakannya: master TIDAK ditimpa, dan sebabnya dicatat di
-- bahan_baku_harga_history supaya terlihat, bukan hilang diam-diam.
--
-- KENAPA INI PERLU
-- ================
-- bahan_baku_harga_history mencatat AYAM 51.000 -> 35.000 pada 28 Agustus 2026
-- dari PO bernama TEST/PO/PARTIAL/1787895628258, kembali 53.500 pada 1
-- September. PO itu kini sudah dihapus, tetapi kerusakannya bertahan: trigger
-- fill_harga_snapshot menyalin harga_beli APA ADANYA ke
-- surat_jalan_item.harga_snapshot saat surat jalan dibuat, dan snapshot itu
-- BEKU -- 22 baris SJ bertanggal 29 Agu - 1 Sep senilai Rp19.950.000 masih
-- memegang harga uji coba itu sampai sekarang. Mengembalikan master tidak
-- memperbaikinya.
--
-- YANG TIDAK DIUBAH (disengaja)
-- =============================
-- PO uji coba TETAP menulis ledger_stok seperti sebelumnya. Ruang lingkup
-- perubahan ini hanya harga; menghentikan pergerakan stoknya adalah keputusan
-- terpisah yang belum diambil.
--
-- Badan fungsi disalin VERBATIM dari pg_get_functiondef(); yang ditambahkan
-- hanya v_po_uji, penetapannya, satu OR pada cabang penolakan yang sudah ada,
-- dan catatan riwayat yang membedakan kedua sebab.
