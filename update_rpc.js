...
$$;
  ...
  // Create a new migration file since we are using local Supabase migrations
  const fs = require('fs');
  const migrationPath = 'supabase/migrations/20260803120000_update_petty_cash_status.sql';
