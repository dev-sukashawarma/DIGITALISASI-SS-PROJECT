...
import { Sandwich, ArrowRight } from 'lucide-react'
...
export default function RecommendationsClient({ settings }: { settings: RecommendationSettings }) {
  ...
  useEffect(() => {
    ...
    async function initData() {
      ...
      const { recIds, upIds, unavIds } = settings
