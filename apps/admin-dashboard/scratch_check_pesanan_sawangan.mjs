...
async function checkSawanganOrders() {
  ...
  if (!outlet) {
    console.log("Outlet Sawangan not found. Available outlets:")
  ...
  console.log(`\n=== PESANAN TIKTOK GO DI SAWANGAN TANGGAL 14 AGUSTUS 2026 ===`)
  if (!orders || orders.length === 0) {
    ...
    console.log(`\nGRAND TOTAL SAWANGAN: Rp ${grandTotal.toLocaleString('id-ID')}`)
