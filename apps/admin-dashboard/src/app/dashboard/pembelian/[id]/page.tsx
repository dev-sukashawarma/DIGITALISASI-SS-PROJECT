...
import { usePODetail, useUpdatePOStatus, useUploadInvoice, getSignedInvoiceUrl, type POStatus } from '@/hooks/usePurchaseOrder'
...
export default function PODetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data: po, isLoading, error } = usePODetail(id)
