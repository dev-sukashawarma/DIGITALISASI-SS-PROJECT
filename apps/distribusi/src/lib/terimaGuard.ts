 ...
 *
 * SALINAN dari apps/stok/src/lib/stok/terimaGuard.ts -- sengaja diduplikasi
 * (pola yang sama dengan printLayout): kedua app memanggil RPC yang sama tapi
 * tidak berbagi paket. Kalau salah satu diubah, ubah keduanya.
 *
