                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <select id="newSkuTingkatan" className="w-full text-sm p-2 border border-gray-300 rounded-md bg-white focus:border-suka-orange outline-none">
                        ...
                        {!bahanBaku.skus?.some(s => s.tingkatan_satuan === 'Besar') && <option value="Besar">Besar</option>}
                        {!bahanBaku.skus?.some(s => s.tingkatan_satuan === 'Tengah') && <option value="Tengah">Tengah</option>}
                        {!bahanBaku.skus?.some(s => s.tingkatan_satuan === 'Kecil') && <option value="Kecil">Kecil</option>}
                      </select>
                    </div>
                    <div>
