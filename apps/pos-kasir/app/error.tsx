...
export default function Error({
  ...
  // Coba deteksi kode error dari error.message jika ada (misal "503 Service Unavailable")
      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div className="p-8 text-center">
          ...
          <div className="flex flex-col gap-3">
            <button
              onClick={() => reset()}
              className="w-full py-3.5 px-4 bg-gray-900 hover:bg-gray-800 text-white rounded-xl font-bold transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
            >
            ...
            <button
              ...
              className="w-full py-3.5 px-4 bg-white border-2 border-gray-200 hover:bg-gray-50 text-gray-700 rounded-xl font-bold transition-colors flex items-center justify-center gap-2"
            >
