-- =============================================================================
-- FIX: Toleransi Sinonim Satuan (Pcs/Lembar/Bungkus/Pack) & Satuan Tengah
-- =============================================================================
    ...
    WHEN EXISTS (
        ...
        WHERE ri.bahan_baku_id = sb.bahan_baku_id
          ...
          AND (
            ...
            (sb.saldo / 
              CASE 
                  -- 1a. Resep persis sama dengan Satuan Kecil
                  ...
                  -- 1b. Resep menggunakan sinonim Satuan Kecil (pcs/lembar/bungkus/pack)
                  ...
                  -- 1c. Resep persis sama dengan Satuan Tengah
                  ...
                  -- 1d. Resep menggunakan sinonim Satuan Tengah
                  ...
                  -- 3b. Resep menggunakan gram/ml, tapi master data satuan_kecil-nya Kg/Liter
