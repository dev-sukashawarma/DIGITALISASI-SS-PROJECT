...
- KPI: revenue per outlet (sales disinkron dari Ecosystem via Edge Function + pg_cron), top item, jam ramai, COGS & waste (ledger), status distribusi, ringkasan kehadiran
