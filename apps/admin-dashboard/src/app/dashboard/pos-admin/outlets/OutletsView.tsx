    ...
    <div className="animate-fade-in space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm sm:text-base font-medium">Kelola data outlet Shawarma. Total: <span className="font-bold text-gray-900">{initialOutlets.length}</span> cabang.</p>
        </div>
