...
- **Konstanta Jarak Maksimal (Radius)**: `GEOFENCE_RADIUS_M = 100` meter.
...
- **Kondisi Lolos**:
  `Adjusted Distance <= 100`
- **Contoh Kasus**:
  - Jarak 110m, Akurasi 20m $\rightarrow$ Adjusted = $110 - 20 = 90m$ ($\le 100m \rightarrow$ **Lolos**)
