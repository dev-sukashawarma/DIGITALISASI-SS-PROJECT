...
const APPROVER_ROLES = ['kitchen', 'spv', 'leader', 'regional_manager'] as const
...
const OPNAME_APPROVER_ROLES = ['leader', 'regional_manager', 'spv', 'kitchen', 'admin', 'owner'] as const
...
const PERMINTAAN_APPROVER_ROLES = ['kitchen', 'admin', 'owner'] as const
